...
//defines
#define SSID_REDE "VIVOFIBRA-95CC"  //coloque aqui o nome da rede que se deseja conectar
...
String ChaveEscritaThingSpeak = "76YVUA9DZOBFB3TU";
...
//Retorno: nenhum
void EnviaInformacoesThingspeak(float umid, float umidAmb, float tempAmb)
{
    String StringDados = "";
    StringDados = ChaveEscritaThingSpeak+"&field1="+String(umid)+"&field2="+String(umidAmb)+"&field3="+String(tempAmb)+"\r\n\r\n";
...
float FazLeituraUmidadeAmbiente(void)
{
  return dht.readHumidity();
}

float FazLeituraTemperaturaAmbiente(void)
{
...
void loop()
{
    float UmidadePercentualLida = 0;
    int UmidadePercentualTruncada = 0;
    char FieldUmidade[11];
    float umi_ambiente = 0;
    ...
    umi_ambiente = FazLeituraUmidadeAmbiente();
    temp_ambiente = FazLeituraTemperaturaAmbiente();
      ...
      (millis() - lastConnectionTime > INTERVALO_ENVIO_THINGSPEAK))
    {
        ...
        EnviaInformacoesThingspeak(UmidadePercentualLida,umi_ambiente,temp_ambiente);
